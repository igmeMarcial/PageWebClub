...
export const WassIcon = ({ className, ...rest }) => (
  <svg
  ...
  >
    <path
      fill="url(#paint0_linear_whatsapp_mobile_logo)"
    ...
    <path
      fill="url(#paint1_linear_whatsapp_mobile_logo)"
    ...
    <defs>
      <linearGradient
        id="paint0_linear_whatsapp_mobile_logo"
        x1={18.942}
        x2={18.942}
        y1={34.138}
        y2={1.461}
      ...
      <linearGradient
        id="paint1_linear_whatsapp_mobile_logo"
        x1={18.942}
        x2={18.942}
        y1={34.724}
        y2={0.875}
      ...
      <pattern
        id="pattern0_whatsapp_mobile_logo"
        width={1}
        height={1}
      ...
      <pattern
        id="pattern1_whatsapp_mobile_logo"
        width={1}
        height={1}
        patternContentUnits="objectBoundingBox"
      >
      ...
      <image
        xlinkHref="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAANMAAADTCAYAAAAbBybZAAAACXBIWXMAAAsSAAALEgHS3X78AAAA"
        id="image0_whatsapp_mobile_logo"
      />
    </defs>
  </svg>
);
...
export const TikTokIcon = ({ className, ...rest }) => (
  ...
  >
    ...
    >
      <path
        d="M36.203 35.438v-3.51a27.092 27.092 0 0 0-3.677-.268c-15.047 0-27.289 12.244-27.289 27.291 0 9.23 4.613 17.401 11.65 22.342a27.18 27.18 0 0 1-7.328-18.58c0-14.833 11.894-26.929 26.644-27.275"
        style={{
          stroke: "none",
          strokeWidth: 1,
          strokeDasharray: "none",
      ...
      />
      <path
        d="M36.847 75.175c6.714 0 12.19-5.341 12.44-11.997l.023-59.417h10.855a20.558 20.558 0 0 1-.35-3.762H44.989l-.025 59.419c-.247 6.654-5.726 11.993-12.438 11.993-2.015.001-4-.49-5.782-1.431a12.444 12.444 0 0 0 10.103 5.195M80.441 23.93v-3.302a20.496 20.496 0 0 1-11.232-3.339 20.632 20.632 0 0 0 11.234 6.641"
        style={{
          stroke: "none",
          strokeWidth: 1,
          strokeDasharray: "none",
      ...
      />
      <path
        d="M69.209 17.286a20.537 20.537 0 0 1-5.073-13.522h-3.972a20.664 20.664 0 0 0 9.045 13.522m-36.683 29.2c-6.88.008-12.455 5.583-12.463 12.463a12.47 12.47 0 0 0 6.679 11.032 12.378 12.378 0 0 1-2.358-7.268c.007-6.88 5.582-12.457 12.463-12.465 1.284 0 2.515.212 3.677.577V35.689a27.092 27.092 0 0 0-3.677-.268c-.216 0-.429.012-.643.016v11.626a12.279 12.279 0 0 0-3.678-.577"
        style={{
          stroke: "none",
          strokeWidth: 1,
          strokeDasharray: "none",
      ...
      />
      <path
        d="M80.441 23.93v11.523a35.261 35.261 0 0 1-20.627-6.633v30.13c0 15.047-12.24 27.289-27.287 27.289a27.128 27.128 0 0 1-15.639-4.947 27.21 27.21 0 0 0 19.959 8.709c15.047 0 27.289-12.242 27.289-27.287v-30.13a35.26 35.26 0 0 0 20.627 6.633v-14.83c-1.484 0-2.927-.161-4.323-.46"
        style={{
          stroke: "none",
          strokeWidth: 1,
          strokeDasharray: "none",
...
export const CircularTextNew = ({ className, ...rest }) => (
  <svg
    ...
    {...rest}
  >
    <path d="M154.2 29.3c-.6.7-1.4 4-1.8 7.5-.7 6.8.3 9.2 4 9.2s4.6-1.9 4.6-9.6c0-5.6-.3-7.3-1.6-7.8-2.4-.9-4.1-.7-5.2.7zm3.8 7.1c0 4.9-1.2 8-2.3 5.9-.7-1.5.5-11.3 1.4-11.3.5 0 .9 2.4.9 5.4zM129.8 29.5c-.3.3-.1 2.9.4 5.8.4 2.8 1.1 6.7 1.4 8.4.3 2.1 1.1 3.3 2.1 3.3 1.3 0 1.4-.7.9-3.9-.3-2.2-.2-4.2.3-4.5 1.1-.7 2.1 1.8 2.1 5.5 0 2.6 1.7 3.9 3.1 2.4.3-.2 0-4.2-.6-8.7-.8-6.8-1.4-8.3-2.9-8.6-1.6-.4-1.8 0-1.2 3.3.6 2.8.4 3.6-.6 3.3-.7-.3-1.4-1.9-1.6-3.6-.3-2.9-1.9-4.1-3.4-2.7zM166.2 36.3c-.6 4-1.4 8.1-1.8 9-.4 1.3-.1 1.7 1.5 1.7 1.7 0 2.1-.6 2.1-3.4 0-1.9.5-3.8 1-4.1.6-.4 1 1.2 1 3.9 0 3.4.4 4.6 1.5 4.6.8 0 1.5-.2 1.5-.4s.7-3.9 1.5-8.2c1-5.4 1.2-8.1.5-8.8-1.4-1.4-2.9 1-3.1 4.9-.2 2.2-.4 1.8-.8-1.5-.4-2.9-1.1-4.6-2.2-4.8-1.2-.2-1.8 1.3-2.7 7.1zM118 32.8c-2.2 1.7-2.2 1.8-.5 8.2 2.1 8.6 5.5 10.8 9.1 6.4 1.7-2.1.5-6.4-1.7-6.4-1.6 0-1.8.5-1.3 2.5.3 1.4.2 2.5-.4 2.5-.5 0-1.5-2-2.1-4.4-1.4-5.5-1.4-6.6-.1-6.6.6 0 1 .7 1 1.5s.9 1.5 1.9 1.5c1.5 0 1.8-.5 1.4-2.3-.5-2.1-2.9-4.7-4.4-4.7-.4 0-1.7.8-2.9 1.8zM181.5 33.3c-1.9 5.6-4.7 15.9-4.4 16.1.2.2 1.9.7 3.7 1.1 2.5.5 3.2.3 3.2-.9 0-.9-.7-1.6-1.5-1.6-1.9 0-1.9-.5.5-7.5 1.1-3.2 2-6.1 2-6.5 0-1.4-3.1-2-3.5-.7zM106 36.1c-3.3 1.3-3.2 1-1.5 6 .7 2.4 1.9 6.3 2.5 8.6.8 3.1 1.4 4.1 2.6 3.6.9-.3 1.2-1.2.9-2.4-.4-1.3-.1-1.9.9-1.9.9 0 1.6.4 1.6 1 0 .5.9 1 2.1 1 1.1 0 1.9-.3 1.7-.8-.2-.4-2.1-4.2-4.2-8.5-2.1-4.2-3.9-7.7-4-7.6 0 0-1.2.5-2.6 1zm5 10.6c0 .7-.4 1.3-.8 1.3-.8 0-3.2-6.7-3.2-8.6.1-1.3 3.9 5.9 4 7.3zM190.2 44.2c-2.4 6.2-2.9 8.4-2 8.9 1.7 1.1 2 .6 5.5-8.3 2.6-6.4 2.9-7.8 1.6-8.2-.8-.3-1.5-.6-1.6-.6-.2 0-1.7 3.7-3.5 8.2zM197.7 47.6c-3.4 6.9-3.9 9.4-1.8 9.4.4 0 1.6-1.9 2.7-4.1 2.2-5 3.1-3.6 1 1.6-1.4 3.2-1.4 3.7 0 4.2 1.8.7 1.2 1.4 6.2-7.9 3.4-6.4 3.8-7.7 2.5-8.2-1.8-.7-1.6-1-3.2 3.1-1.9 4.7-3.3 4.1-1.6-.6.7-2.2 1.1-4.2.8-4.5-1.6-1.6-3.2 0-6.6 7zM93.2 42.1c-3.6 1.3-3.6 3.4-.2 9.8 3.7 6.9 6.2 8.3 9.3 5.3l2-2.1-3.1-6.4c-3.5-7-4.5-7.9-8-6.6zm4.6 7.4c2.4 4.9 2.8 7 1.2 6-1.2-.7-5-7.9-5-9.5 0-2.3 1.7-.7 3.8 3.5zM209.6 54.1c-5 7.5-5 7.3-.2 10 1.4.8 2.1.8 2.7-.2.5-.9.3-1.7-.6-2.2-1.7-.9-1.8-1.6-.6-3.6.8-1.2 1.3-1.2 2.4-.3 1.1 1 1.7.9 2.6-.2 1-1.1.9-1.6-.4-2.3-2.3-1.3-.9-4.6 1.4-3.3 1.2.6 2.2.5 2.9-.2.9-.9.5-1.6-1.6-3-1.5-1-3-1.8-3.3-1.8-.3 0-2.7 3.2-5.3 7.1zM79.6 50.6c-2.2 2.1-2.1 2.3 2.2 8.5 4 5.8 7.7 7.4 10.2 4.5 1-1.3 1-2.2 0-4.6-1.3-3.2-1.8-3.4-3.7-2.2-.8.5-.9 1.3-.3 2.2 1.2 1.8 1.3 3 .3 3-1.2 0-6.6-9-5.9-9.7.3-.4 1.2.1 1.9 1 .8 1.1 1.7 1.4 2.7.7 1.2-.7 1.2-1.2-.4-2.9-2.3-2.5-4.9-2.7-7-.5zM77.2 65.2c-1.2 1.2-1.7 3.8-.7 3.8.8 0 4.5-3.4 4.5-4.2 0-1.2-2.5-.9-3.8.4zM64.4 67.5c-.5 1.2-1 1.3-2 .4-1.1-.9-1.7-.9-2.8 0-1.1.9-.1 2.3 5.3 7.6 5.6 5.4 6.7 6.1 7.5 4.7.5-.9 1.5-2.1 2.3-2.5 2.5-1.5 1.3-4.6-3.1-8.1-4.7-3.9-6.4-4.4-7.2-2.1zm5.6 5c1.8 1.9 3 3.8 2.7 4.2-.8.7-7.7-5.5-7.7-6.9 0-1.6 1.7-.7 5 2.7zM55.5 76.8c-.4 1.1.2 2.3 1.9 3.4 5.3 3.9 7.1 5.7 6.4 6.3-.4.4-2.8-.9-5.4-2.9-3.7-2.8-5-3.4-6.1-2.4-.8.6-1 1.4-.6 1.8 2 1.7 11.1 8 11.6 8 .2 0 1.6-1.5 3-3.3l2.5-3.3-6.3-4.6c-5.3-3.9-6.5-4.4-7-3zM225.7 76.7c-1.1 1 1.3 3.2 2.9 2.6 1.1-.4 1.2-.9.3-1.9-1.3-1.5-2.2-1.8-3.2-.7zM242.1 84c-6.2 4-7.9 7.4-4.6 8.6.8.4 1.5 1.2 1.5 2 0 1.9.5 1.8 4.9-1.4 3.2-2.3 3.7-3.2 2.9-4.6-.9-1.7-1.1-1.6-2.9.3-1.7 1.8-4.9 2.9-4.9 1.6 0-.2 2-1.8 4.4-3.5 4.8-3.3 7.7-4.1 5.6-1.6-.7 1-.8 2.1-.3 3.1.8 1.4 1.1 1.4 2.7-.4 2.1-2.3 1.4-5.6-1.4-7.1-1.4-.7-3.1-.1-7.9 3zM44.7 87.3c-.6 1.6 13.8 11.1 15.4 10.1 2.1-1.2.5-3.1-5.9-6.9-8-4.8-8.8-5-9.5-3.2zM248.7 95.9c-3.8 1.6-6.8 3.1-6.8 3.4.1.4.1 1.2.1 1.8 0 .6.9.8 2 .4 2.2-.7 3 2 .8 2.8-1 .3-1 .8-.2 1.7.9.9 2.7.2 8-3.1 3.8-2.3 7.1-4.4 7.3-4.6.9-.6-1.9-5.3-3.1-5.2-.7.1-4.4 1.3-8.1 2.8zm6.5 1.3c-.6.7-2.4 2.1-4.1 3.1-2.3 1.3-3.1 1.5-3.1.5 0-.7 1.7-2 3.8-3 4.7-2 4.6-2 3.4-.6zM42.5 98.3c-2.1 3.3-1.2 4.9 4.1 7.5 5.8 2.9 7.8 2.8 9.3-.4 1-2.2.9-3-.5-4.5-.9-1.1-2.3-1.9-3.1-1.9-1.9 0-1.6 2.7.4 3.9 3.8 2.1 0 2.3-4.3.2-4.5-2.1-5.1-3.6-1.6-3.6 2.5 0 2.1-2.9-.5-3.3-1.4-.2-2.7.5-3.8 2.1zM254.6 107.6c-8 2.7-8 2.8-7.2 4.9.5 1.4.8 1.4 3.5 0 1.7-.8 3.6-1.5 4.3-1.5.7.1-.4 1-2.4 2.1-2.5 1.3-3.8 2.6-3.8 4 0 1.1.4 1.9.8 1.7.4-.2 4.2-1.6 8.5-3.2 4.8-1.8 7.7-3.4 7.7-4.4 0-1-.6-1.2-2-.8-5.8 1.8-6.4 1.7-2.9-.6 2-1.3 3.4-2.9 3.2-3.6-.6-1.6-1.6-1.5-9.7 1.4zM32.3 116.6c-.3.8-.1 2 .4 2.5 1.1 1.1 15.5 4.8 16.6 4.2 2-1.2.3-3.2-3.1-3.8-2.2-.3-5.1-1.3-6.6-2.1-1.6-.7-3.2-1.1-3.7-.8-.5.3-.9 0-.9-.5 0-1.7-2-1.3-2.7.5zM263.5 120.5c-.5.2-3.6.6-6.7 1-4.1.4-5.8 1.1-5.8 2.1 0 .8.9 1.4 2 1.4 2.3 0 2.7 1.8.5 2.6-1.5.6-2.2 3.4-.8 3.4.4 0 4.4-1.2 9-2.7 6-2 8.2-3.1 7.8-4.1-.3-.7-.5-2-.5-2.8 0-1.3-2.9-1.8-5.5-.9zm0 4c-3.5 1.6-6.5 1.9-6.5.6 0-.9 3.3-1.7 7.5-1.9 1.5 0 1.2.3-1 1.3zM30 126.8c0 1.4 1.4 2 6.8 3 3.7.6 7.7 1.5 9 1.8 1.7.5 2.2.2 2.2-1.3 0-1.7-1.2-2.3-8.2-3.7-10.2-2-9.8-2-9.8.2zM259 133.9c-4 .4-5.5 1-5.5 2.1s1 1.4 4.3 1.2c2.3-.1 4.2.2 4.2.8 0 .5-1.8 1-4 1-3.4 0-4 .3-4 2.1 0 2 .3 2.1 4.3 1.4 2.3-.4 5.6-.7 7.2-.6 4.7.2 6.7-1.7 5.9-5.7-.7-3.5-.7-3.5-12.4-2.3zM32.2 136.2c-1.9 1.9-1.4 5.6.8 6.8 1.1.6 4.4 1 7.3.8 4.9-.3 5.2-.4 5.5-3.3.3-1.9-.2-3.3-1.4-4.2-2.2-1.6-10.6-1.7-12.2-.1zm9.6 2.4c3.1.9 2.8 2.4-.5 2.4-3.8 0-7.3-1-7.3-2.1 0-1 4.4-1.2 7.8-.3zM28 150.2c0 1.3 1.1 1.8 5.3 2l5.2.4-5.2.8c-7.1 1.2-7.3 3.6-.3 3.6 2.8 0 5 .4 5 1 0 .5-2.2 1-5 1-4.3 0-5 .3-5 2 0 2.3-.4 2.3 5.7 1.1 2.6-.5 6.5-1.2 8.6-1.6 2.8-.4 3.7-1.1 3.7-2.5 0-1.7-.7-2-4-2-2.2 0-4-.5-4-1 0-.6 1.8-1 4-1 3.3 0 4-.3 4-2 0-1.2-.7-2-1.7-2.1-1 0-5.1-.4-9-.8-6.5-.6-7.3-.5-7.3 1.1zM255.6 155.3c-1.2.9-1.7 2.3-1.4 4.2.4 4.2 4.9 4.7 8.7 1.1 2.8-2.7 5.2-2.6 2.6.1-1.9 1.8-1.9 3.3-.1 3.3 2.2 0 3.8-2.6 3.4-5.7-.4-3.9-4.2-4.4-7.5-.9-2.4 2.6-4.3 3.4-4.3 1.7 0-.5.7-1.1 1.5-1.5 1.8-.7 2-3.6.2-3.6-.7 0-2.1.6-3.1 1.3zM252.7 168.2c-.4 1.4.3 1.9 3.2 2.4 2 .3 5.3 1 7.4 1.4 3 .6 4 .5 4.4-.6.7-2 .8-2-7.4-3.6-6.7-1.3-7.2-1.3-7.6.4zM46.2 172.9c-1.4.8-.6 4.1.9 4.1 1.4 0 2.3-3 1.3-4-.5-.5-1.5-.6-2.2-.1zM249.2 183.2c-2.5 2.5-.8 7.8 2.5 7.8 1.8 0 1.6-2.7-.3-3.4-2.2-.9-.8-2.5 1.7-1.9 1.7.5 2 1.1 1.5 3.5s-.2 3 2.1 3.9c3.1 1.2 6.3-1.1 6.3-4.6 0-1.7-1.1-2.7-5.1-4.4-6-2.4-7.1-2.5-8.7-.9zM43.7 190.3c-5.3 2.2-7.6 3.7-7.4 4.7.1.8 1 1.4 2 1.4.9-.1 1.9.7 2.2 1.7.8 2.5 2.3 2.4 9-.5 5.1-2.3 6.6-4.2 4.8-6-.5-.4-.9-1.2-.9-1.7-.1-.5-.2-1.4-.3-1.9-.2-1.4-.6-1.3-9.4 2.3zm8.1 1.8c-.5 1.6-8.7 4.9-9.3 3.8-.4-.5 1.3-1.8 3.7-2.9 4.9-2.2 6.1-2.4 5.6-.9zM244.2 195.2c-1.5 1.5-1.6 5 0 6.6 1.5 1.5 5.4 1.6 6.3.2.3-.6 1.6-1 2.8-.9h2.2l-2.2 1.6c-2.9 2-2.9 3.3 0 3.3 1.6 0 2.8-.9 3.5-2.5 1.7-3.6 1.5-4.4-1.2-5.6-1.8-.8-3-.7-5.3.5-2.9 1.5-4.3 1.3-4.3-.6 0-.5.8-.8 1.8-.6 1 .2 1.7-.3 1.7-1.2 0-1.9-3.6-2.5-5.3-.8zM51.2 202c-5.5 3.5-8.1 7-5.2 7 .6 0 1 .7 1 1.5 0 2.9 2.7 2.6 8.9-1.1 4.8-2.8 5.9-3.9 5-5-.8-1-2-.7-6 1.7-2.7 1.7-5.5 2.9-6.1 2.6-1.1-.3 6.6-6 9.5-7 .7-.2.7-.9.1-2-.8-1.4-1.7-1.2-7.2 2.3zM237.6 206.6c-.8 2.2-.9 2.1 2.2 2.7 1.5.3 4.1 1.8 5.7 3.2 1.5 1.5 3.3 2.8 3.9 2.9.6.1 1.6.5 2.2.9.7.4 1.5 0 1.8-.8.6-1.8-2.2-5.5-4.2-5.5-.7 0-3-1.1-5-2.5-4.3-2.9-5.8-3.1-6.6-.9zM57.5 214c-3.3 2.6-4.9 4.6-4.7 5.7.3 1.5.1 1.6-.9.5-.7-.6-1.7-1.2-2.1-1.2-1.1 0-1 2.8.2 3.5 1.2.8 16.1-9.6 15.6-11-.6-2.1-3.3-1.3-8.1 2.5zM233.2 214.1c-.5 1.1-1.2 2-1.7 1.9-.6 0-1.1.5-1.2 1.2-.3 2.1 9.5 9 11.7 8.3 2.1-.7 3.6-4.7 2.5-6.5-.9-1.5-2.5-.2-2.5 2.2 0 1.7-.3 1.8-1.4.8-1.1-.8-1.2-1.8-.6-3.6.8-1.9.5-2.8-1.2-4.4-2.8-2.6-4.7-2.5-5.6.1zM63.2 220c-2.8 2.8-5.2 5.4-5.2 6 0 .5.9 1.5 2 2.2 1.1.7 2 1.6 2 2 0 .4 1.1 1.9 2.4 3.3l2.4 2.6 5.6-5.2c4.5-4.2 5.4-5.5 4.4-6.6-.9-1.2-1.9-.7-5.4 2.8-2.3 2.3-4.7 4-5.4 3.7-.7-.2.9-2.3 3.5-4.7 3.2-2.9 4.4-4.6 3.7-5.3-.7-.7-2.6.2-5.9 3.1-2.8 2.3-5 3.6-5.2 2.9-.2-.6 1.5-2.8 3.9-4.8 3.3-2.8 4.1-4 3.4-5.3-.8-1.3-1.7-.8-6.2 3.3zM223.4 224.5c-1.6 2.4-1.6 2.7.1 4.5 1.2 1.3 3.1 2 5.7 2 2.1 0 3.8.5 3.8 1.1 0 .5-.4.8-.8.5-1.3-.8-3.5 1.1-2.8 2.3 1.2 1.9 4.5 1.2 6.2-1.4 1.6-2.4 1.5-2.7-.1-4.5-1.2-1.3-2.9-1.8-5.3-1.7-2.2.1-3.7-.3-4-1.2-.3-.9.1-1.1 1.6-.7 2.4.8 4.1-1.2 2.1-2.5-2.5-1.5-4.8-1-6.5 1.6zM245.1 224.9c-.8 1.4-.7 2.2.3 3 1.1.9 1.5.6 2-1.1.8-3.2.7-3.8-.4-3.8-.5 0-1.4.9-1.9 1.9zM84.9 238.9c-2.3 3.3-4 4.9-5.3 4.8-2.8-.3-3.1 1.9-.4 2.8 1.3.4 2.6.8 3 .9.4.1 2.5-2.3 4.7-5.3 3.1-4.2 3.8-5.7 3-6.8-.6-.7-1.3-1.3-1.4-1.3-.1 0-1.8 2.2-3.6 4.9zM210.3 235.1c-.8.8.1 2.8 3.5 7.3 6.1 8.2 5.8 7.9 7.5 7 1.2-.7.6-2.2-3.7-8.1-2.8-4-5.3-7.3-5.6-7.3-.4 0-1.1.5-1.7 1.1zM204.2 239.2c-.7.9 0 3 2.6 7.5 3.8 6.5 4.9 7.3 5.8 4.8.5-1.1-6.1-13.5-7.1-13.5-.1 0-.7.6-1.3 1.2zM93 241.5c-1.1 1.3-1.1 1.8 0 2.8 1 .9 1.3.9 1.7-.1.7-1.7 2.3-1.5 2.3.3 0 2-2.8 3.1-4.3 1.6-1.6-1.6-2.2-1.4-3.5 1.4-1.7 3.6-1.5 4.2 1.2 6 3.2 2.1 4.9 1.2 8-4.4 3.1-5.7 3-5.5 1-7.5s-4.8-2-6.4-.1zM194.7 244.8c-1 1-1.7 2.6-1.7 3.5 0 1.9 3.7 4.7 6.2 4.7.9 0 2 .5 2.4 1.2.5.7.2.9-.8.6-2.2-.9-4.6.8-3.2 2.2 1.6 1.6 5.5.9 6.8-1.3 1.5-2.3-.3-5.1-3.7-5.5-2.7-.3-5.4-2.8-4.4-3.9.4-.3 1.4 0 2.2.7 2.3 1.9 4.1-.2 2-2.4-2.1-2.1-3.8-2-5.8.2zM104.9 245.2c-.1.7-.1 1.7 0 2.1.2 1.1-3 7.1-4.1 7.8-.5.3-1.1 2-1.3 3.7-.3 2.6 0 3.2 1.4 3.2 2 0 2.3-.5 5.1-8 .9-2.5 2-5.3 2.4-6.2.5-1.1.1-2-1.3-2.8-1.6-.8-2.1-.8-2.2.2zM183.6 248.9c-.3.5 0 1.4.7 2 .8.6 1.9 3 2.6 5.3 2 6.7 3.3 8.9 5 8.6 1.1-.2 1.5-1.2 1.2-3.3-.1-1.7-.6-3.2-1-3.5-.5-.3-1.6-2.6-2.6-5.3-1.2-3.2-2.3-4.7-3.6-4.7-1 0-2 .4-2.3.9zM112.1 251.2c-.7 1.7-.4 3.2 1 5.7 2.2 3.8 1.8 5.2-.7 2.7-1.9-2-3.8-.8-2.8 1.7.7 1.9 4.6 3.2 6.9 2.3 1.9-.7 1.9-4.6 0-7.2-1.7-2.2-1.9-4.4-.5-4.4.6 0 1 .6 1 1.4 0 2 2.7 2.8 3.4 1 .8-2.1.8-2-1-3.8-2.3-2.4-6.3-2-7.3.6zM124.7 253.3c-.3 1.2-.9 4.5-1.3 7.4-.6 4.6-.4 5.2 1.5 6.3 2.6 1.3 6.1.5 6.1-1.5 0-1.8-2.3-3.2-2.8-1.7-.5 1.7-2.2 1.5-2.2-.3 0-.8 1.2-1.8 2.8-2.1 3.3-.8 4.2-2 4.2-5.7 0-2.1-.5-2.7-2.1-2.7-1.1 0-2.9-.4-3.9-1-1.4-.8-1.9-.5-2.3 1.3zM173 252.5c-1 1.2-1 2.5 0 6.2.6 2.6 1.6 5.3 2.2 6 1.4 1.7 5.3 1.6 6.7-.1 1.4-1.7.6-8-1.5-11.4-1.7-2.5-5.5-2.9-7.4-.7zm5.7 5.7c1 3.8.3 7.4-1 5.1-1-1.7-1.8-9.3-1-9.3.5 0 1.4 1.9 2 4.2zM212.5 253.3c-1.2 1-1.4 1.6-.7 2.1 1.7 1 4.3-.7 3.3-2.2-.6-.9-1.1-.9-2.6.1zM137 257.7c0 2.1-.3 6.2-.6 9l-.7 5.3h3.2c2.8 0 3.1-.3 3.2-3.3 0-1.7.4-4.1.9-5.2.7-1.7.9-1.6.9 1 .2 5.1 1.2 7.3 3.6 7.7 2.1.5 2.3.1 2.9-7.9.3-4.7.4-8.9.1-9.4-1.5-2.4-2.5-.3-2.5 5.3 0 7.4-1.7 6.8-2.2-.7-.2-3.6-.7-5.1-1.9-5.3-1.3-.2-1.8.9-2.4 5.3-.8 6.8-2.4 6.5-1.7-.5.4-4.1.2-5-1.2-5-1.2 0-1.6 1-1.6 3.7zM156.7 254.6c-1.1 1.1.3 2.4 2.4 2.4 1.2 0 1.9-.5 1.7-1.3-.5-1.4-3.1-2.1-4.1-1.1z" />
  </svg>
);

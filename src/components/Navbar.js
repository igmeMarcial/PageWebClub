...
import Tok from "../../public/images/svgs/tiktok-logo-4500.svg";
import {
  DribbbleIcon,
  GithubIcon,
  LinkedInIcon,
...
const linksSocialMedia = {
  twitter: "#", // Twitter
  whatsapp: "#", // WhatsApp
  instagram: "https://www.instagram.com/cristhian_vasquez98/", // Instagram
  facebook: "#", // Facebook
  telegram: "#", // Telegram
  tiktok: "#",
};
    ...
    >
      ...
      <div className="w-full flex justify-between items-center lg:hidden">
        <nav className="flex items-center justify-center">
          ...
          <CustomLink className="mx-4" href="/history" title="Mi historia" />
          <CustomLink className="mx-4" href="/club" title="Wolf Club" />
          <CustomLink className="ml-4" href="/master" title="Master Mind" />
        </nav>
        <nav
      ...
      "
        >
          ...
          <motion.a
            target={"_blank"}
            className="w-6 mx-3"
            href={linksSocialMedia.facebook}
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
          ...
          <motion.a
            target={"_blank"}
            className="w-6 mx-3"
            href={linksSocialMedia.instagram}
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
          ...
          <motion.a
            target={"_blank"}
            className="w-6 mx-3 bg-light rounded-full bg-transparent"
            href={linksSocialMedia.tiktok}
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
